...
void Sample_UI::InitObject()
{
    //SceneManager::LoadScene("MobileMain");
    ...
    if (true)
    {
        ...
        SceneManager::SaveScene("MobileMain");
    }
    if (false)
    {
        // Text (RectTransform)
        ...
        SceneManager::SaveScene("MobileChar");
    }
    if (false)
    {
        // Text (RectTransform)
